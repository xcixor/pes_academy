...
from application.services import (
    ...
    get_draft_application_data_to_redis_cache,
...
class RedisCacheTestCase(TestCase):
    ...
    def test_can_get_draft_application_data_to_redis_cache(self):
        self.set_draft_application_data_to_redis_cache()
        data = get_draft_application_data_to_redis_cache('1')
    ...
    def test_updates_if_similar_id(self):
        ...
        self.set_draft_application_data_to_redis_cache()
        updated_data = get_draft_application_data_to_redis_cache('1')
