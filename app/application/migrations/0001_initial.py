    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expected_max_score', models.IntegerField(default=35, verbose_name='Expected Max Score')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='draft', to='application.application')),
            ],
        ),
        migrations.CreateModel(
