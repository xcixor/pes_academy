...
from academy.presentation.views import (
    ...
    GetMaterialPageView, UploadMaterialView, DeleteSessionView)
...
urlpatterns = [
    ...
    path('session/delete/<int:pk>/',
         DeleteSessionView.as_view(), name='delete_session'),
    path(
        '<int:pk>/meeting/',
        GetSetupMeetingPageView.as_view(), name='meeting_setup'),
